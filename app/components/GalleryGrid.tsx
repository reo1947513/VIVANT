        ...
        {images.map((image, index) => (
          ...
          >
            ...
            <Image
              ...
              /* 画面に近づいてから読み込む方式（既定）はやめたまま。
                 後から読むと、スクロールした瞬間や横に送った瞬間に
                 暗い枠が見えてしまい、遅く感じる原因になっていたため。

                 ただし「最初から読む」と「真っ先に読む」は分けている。
                 fetchPriority="low" を付けると、ブラウザは最初の画面に出る
                 ヒーロー写真を取り終えてからこの写真群を取りに行く。
                 合計の受信量は変わらないが、最初の画面が出るまでの時間は
                 ヒーロー写真だけで決まるようになる。

                 quality は既定の75から60へ落とす。ここは1枚205px幅の
                 小さな枠に収めるため差が目に見えない一方、受信量は減る。
                 拡大表示（下の lightbox-img）は75のまま据え置き、
                 大きく見たときの画質は変えない。 */
              loading="eager"
              fetchPriority="low"
              quality={60}
