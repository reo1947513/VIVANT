 ...
 *   90度ずつ向きを変えて箱状に組まれたもの。板は剥がれず、開かず、塊のまま動く。
 *   塊は垂直の軸を中心にゆっくり自転し続ける。ページを開いた瞬間から止まらない。
 *   画面を送ると自転が少し速くなり、わずかに傾いて上面や接合部の稜線が覗く。
 *   送るのをやめても自転は続き、速さと傾きだけがゆっくり元へ戻る。
 *   正面を過ぎた板は裏から見えるため、写真は左右反転して見える。
 *   これは箱として回っていることが伝わる手がかりでもあるので、そのままにしている。
 *
 * 作り：
